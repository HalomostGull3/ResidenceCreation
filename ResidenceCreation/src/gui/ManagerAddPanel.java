...
public class ManagerAddPanel extends JPanel {
    ...
    public ManagerAddPanel() {
        ...
        eIDPanel = new ValueEntryPanel("Employee ID");
        eIDPanel.setMaximumSize(eIDPanel.getPreferredSize());
        add(eIDPanel);
        eIDPanel.setAlignmentX(Component.CENTER_ALIGNMENT);
        add(Box.createVerticalGlue());

        // add a panel with the field for the entry of the student's nsid
        consultantPanel = new ValueEntryPanel("Consultant? (y or n)");
    ...
    private class SubmitListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            String eID = eIDPanel.getValueAsString();
            String con = consultantPanel.getValueAsString();
            AddManager addManager = new AddManager();

            CommandArguments cmdArguments = new CommandArguments();
            cmdArguments.mName = name;
            cmdArguments.mSIN = mSin;
            cmdArguments.mEN = eID;
            cmdArguments.response = con;
